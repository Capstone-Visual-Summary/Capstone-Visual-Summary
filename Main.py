from Database_Classes import Database_Parent # If you get en error with not being able to find subclasses
from Embedding_Classes import Embedding_Parent # Change the imports to: from ..... import *
